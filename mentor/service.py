...
def chat():
    ...
    # The browser's graph session id — which map (ui/session/<sid>/graph.json)
    # this chat is about. Distinct from session_id (the chat history key).
    graph_session_id = data.get("graph_session_id") or None
