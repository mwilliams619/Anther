...
| Track sources & search tiers | touching `atlas.search`, `_relevant`, `anther_ml/spotify_deezer.py` or `anther_ml/itunes.py` | [docs/ui.md](docs/ui.md#search-tiers--why-there-are-four) — the tier gate is relevance-based, not emptiness-based, and tiers **top up** rather than stop at the first hit; **read before "simplifying" it** |
